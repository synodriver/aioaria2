...
async def on_download_error(trigger: aioaria2.Aria2WebsocketClient, data: dict):
...
async def on_download_complete(trigger: aioaria2.Aria2WebsocketClient, data: dict):
